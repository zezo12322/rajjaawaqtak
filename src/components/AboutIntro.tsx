...
const TAGS = ["مراكز الشباب", "المدارس", "توعية رقمية", "صحة نفسية", "ورش تفاعلية"]
        ...
        <Reveal>
          <div className="card p-7 md:p-9 h-full">
            ...
            <p className="text-[var(--text)] leading-[1.9]">
              مبادرة مجتمعية تهدف لتوعية النشء والشباب بمخاطر الإدمان الرقمي، من خلال برامج وورش
              تفاعلية في مراكز الشباب والمدارس. هدفنا إننا نساعد كل شاب وفتاة يستعيدوا السيطرة على
              وقتهم، ويبنوا علاقة صحية ومتوازنة مع التكنولوجيا.
            </p>
